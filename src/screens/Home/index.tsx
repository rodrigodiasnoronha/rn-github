...
class Home extends Component<HomeProps, HomeState> {
    constructor(props) {
        ...
        this.onPressBotaoPesquisarUsuarioGithub = this.onPressBotaoPesquisarUsuarioGithub.bind(this);
    }
    ...
    onPressBotaoPesquisarUsuarioGithub() {
        ...
        getUsuarioGithub(this.state.username)
            ...
            .catch((err) => {
                ...
                if (err.response && err.response.status == 404) mensagemErro = "Usuário não encontrado";
